...
module "private_agents" {
  ...
  resource_group_name               = azurerm_resource_group.rg.name
  subnet_id                         = module.network.subnet_id
  network_security_group_id         = module.network-security-group.private_agents_nsg_id
  avset_platform_fault_domain_count = var.avset_platform_fault_domain_count
...
module "public_agents" {
  ...
  resource_group_name               = azurerm_resource_group.rg.name
  subnet_id                         = module.network.subnet_id
  network_security_group_id         = module.network-security-group.public_agents_nsg_id
  avset_platform_fault_domain_count = var.avset_platform_fault_domain_count
